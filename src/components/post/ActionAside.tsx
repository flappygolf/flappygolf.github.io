...
function ShareButton() {
  ...
  const text = `I found this great post: "${postTitle}". Take a look!`
...
function ShareModal({ url, text }: { url: string; text: string }) {
  return (
    ...
    >
      <h2 className="px-3 py-1 font-bold">Share this post</h2>
...
function DonateContent() {
  return (
    <motion.div
      ...
      exit={{ y: 20, opacity: 0 }}
    >
      <h2 className="text-center mb-5">Thanks for your support. It means a lot to me.</h2>
